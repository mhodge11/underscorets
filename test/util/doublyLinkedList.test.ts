...
test("should create an empty list", () => {
	const list = new util.DoublyLinkedList();
...
test("should create a list from an array", () => {
	const list = new util.DoublyLinkedList([1, 2, 3]);
	expect(list).toBeDefined();
...
test("should create a list using the from method", () => {
	const list = util.DoublyLinkedList.from([1, 2, 3]);
	expect(list).toBeDefined();
	expect(list.size).toBe(3);
	expect(list.head?.value).toBe(1);
	expect(list.tail?.value).toBe(3);
...
test("can get value at index", () => {
	const list = new util.DoublyLinkedList([1, 2, 3, 4, 5, 6, 7, 8, 9]);
...
test("can remove value at index", () => {
	const list = new util.DoublyLinkedList([1, 2, 3, 4]);
	list.remove(0);
	list.remove(1);
	list.remove(1);
	list.remove(1);
...
test("can get string for Node", () => {
	const list = new util.DoublyLinkedList([1]);
