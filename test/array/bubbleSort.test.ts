...
test("bubble sort the array in ascending order based on the iteratee function", () => {
	const numbers = [3, 1, 2];
	const sortedNumbers = bubbleSort(numbers, { order: "asc" });
...
test("bubble sorts an array like", () => {
	...
	const sortedArrayLike = bubbleSort(arrayLike, { order: "asc" });
